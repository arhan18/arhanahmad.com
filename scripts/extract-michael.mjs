...
async function extract() {
  ...
  // Extract Tailwind config if visible
  ...
  fs.writeFileSync(path.join(OUTPUT_DIR, 'tailwind-base.json'), JSON.stringify(tailwindData, null, 2));
  console.log('Tailwind base saved');
